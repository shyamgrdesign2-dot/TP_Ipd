        ...
        <>
            <div className="align-items-center d-flex medicine-templates border-top-0 without-hover px-0 pt-0 pb-3">
                ...
                <div className="text-truncate">
                    ...
                    <div className="fontroboto letterspacing fw-medium">{patients_details !== undefined ? patients_details?.pm_pid : "000000"}</div>
                </div>
            </div>
            <div className="align-items-center d-flex medicine-templates border-top-0 without-hover px-0 pt-0">
                ...
                <div className="text-truncate">
                    ...
                    <div className="fontroboto letterspacing fw-medium">{patients_details !== undefined ? patients_details?.pm_contact_no : "000000"}</div>
                </div>
            </div>
            <div>
                <Link to="/edit_patient" replace={true} state={{ patients_details: patients_details }}>
                ...
                {locationPath == '/patient_details' ? '' :
                    <Link to="/patient_details" state={{ patients_details: patients_details }}>
            ...
            {locationPath == '/patient_details' ? (
                <div className={'align-items-center d-flex h-100'}>
                    <div className='align-items-center d-flex'>
                        <div className='patientName'>{`${patients_details !== undefined ? patients_details?.pm_fullname : "Hello Guest"},`}</div>
                        <div className='text-2 fontpoppins fontpoppins1 ms-1'>{patients_details !== undefined ? genderAge(patients_details) : `M, 30y`}</div>

...
export const PERSISTANT_STORAGE_KEY_CLINIC_ID = 'persistant.storage.key.clinic-id';
export const PERSISTANT_STORAGE_KEY_PROFILE = 'persistant.storage.key.profile';

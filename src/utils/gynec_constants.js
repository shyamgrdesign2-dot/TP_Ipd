export const GYNEC_SECTION_ENABLE_LIST = {
    cycle : true,
    flow : true,
    pain : true,
    ageAtMenarche : true,
...
export const REPRODUCTIVE_LIFE_STAGES_LIST = [
...
export const PAIN_OCCURANCE_LIST = [

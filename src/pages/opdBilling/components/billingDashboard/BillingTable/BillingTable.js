...
import { Select, Checkbox, Row, Col, Input, DatePicker, Button, Table } from "antd";
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        ...
        >
          <div className="text-black fs-14 fw-semibold">
    ...
    },
    {
      ...
      render: (text, record) => (
        <div>
          {record.campaign_date}, <br />
          {record.campaign_time}
        </div>
      ),
    },
    {

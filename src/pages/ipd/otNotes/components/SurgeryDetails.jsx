...
const SurgeryDetails = ({ surgeryDetails, id }) => {
  ...
  return (
    <section className="surgery-card" aria-labelledby="surgery-card-title" key={id}>
            ...
            if (typeof surgeryDetails[detail] === 'string') {
              return (
                <li className="surgery-card__item">
                  <span className="surgery-card__label">{SURGERY_DETAILS_MAP[detail]}:</span>{" "}
                  <span className="surgery-card__value">{surgeryDetails[detail]}</span>
                </li>
              )
            }

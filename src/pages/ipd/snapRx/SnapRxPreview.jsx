...
function IPDSnapRxPreview() {
  ...
  const printInAppContent = async () => {
    navigate(`/ipd/snap-rx/preview/?url=${printUrl}&key=print`, {
      replace: true,
      state: state,
    });
    navigate(0, { replace: true });
...
export default IPDSnapRxPreview;

...
import { uploadFiles } from "../../../../../redux/ipd/ipdSnapRxDigitizationSlice";
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageRefs.current?.size) {
      try {
        ...
        console.log('INTEL ==> schemaKey', schemaKey)
  ...
  if (isMobile) {
    return (
      <div className="preview-drawer-overlay">
        <div className="preview-drawer-mobile preview-drawer-mobile-ipd ">

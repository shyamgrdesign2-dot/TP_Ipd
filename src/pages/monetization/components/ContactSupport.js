    ...
    return (
        <div id="contactSupport" className="my-5" ref={(el) => ref && (ref.current.contactSupport = el)}>
            ...
            <div className="d-inline-flex align-items-center rounded-4 p-4" style={{ background: '#4B4AD514' }} >
                <i className="icon-phone fs-18"></i><a className="ms-1 text-main fw-medium fs-16" href='tel:+91-9974042363'>+91-9974042363</a> <div className="mx-2">|</div>
                <img width={19} height={19} src={SMS} /><a className="ms-1 text-main fw-medium fs-16" href='mailto:support@tatvacare.in'>Support@tatvacare.in</a>
            </div>
        </div>
    )
}

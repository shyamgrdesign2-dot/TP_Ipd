...
function TabConsultationHeader({ setAddPatient, isFormValid }) {

    const onAddPatientClicked = () => {
        setAddPatient(Math.random());
    };
  ...
  return (
    <div className="modalCard-header align-items-center d-flex">
      ...
      {/* <Link to="/add_new_patient"> */}
        <Button
          className="btn btn-primary3 me-30 btn-41 px-4 d-flex align-items-center"

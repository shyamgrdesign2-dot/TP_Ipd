...
function TabSearch({ type, passIndex, onClose }) {
    ...
    const onSearchParentClose = useCallback(
        () => {
        ...
        <>
            <Card bordered={false} className="search-modalCard h-100">
                <TabSearchHeader
                    ...
                    onSearchParentClose={onSearchParentClose}
                    onClose={onClose} />
                                ...
                                <div>
                                    ...
                                    <div className="mt-3 d-flex flex-wrap">
                                        {parentSearchOptions.length > 0 &&
                                            parentSearchOptions.map((item, i) => {
                                                return (
                                                    <Button key={i} type="text" className="btn btn-primary2 chips-custom mb-14 me-14" onClick={() => onSelectParent(item.key)}>{item.value}</Button>
                                                )
                                            })}
                                    </div>
                                </div>

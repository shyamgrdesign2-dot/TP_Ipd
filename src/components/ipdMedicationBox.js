...
import { InfoCircleOutlined, LoadingOutlined, MenuOutlined } from "@ant-design/icons";
...
import TabMedicationMoreModal from "../components/tab_design/TabMedicationMoreModal";
                        ...
                        {(provided) => (
                          <tr ref={provided.innerRef} {...provided.draggableProps}>
                            ...
                            <div className="d-flex align-items-center gap-2">
                              <img
                                onClick={() => mainMedicationSelect(row.index)}
                                src={editIcon}
                                width={18}
                                height={18}
                                alt="edit"
